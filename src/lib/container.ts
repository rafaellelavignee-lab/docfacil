...
import { PrismaDocumentPurchaseRepository } from "@/infrastructure/persistence/prisma/document-purchase-repository"
...
export const container = {
  ...
  documentPurchaseRepository: new PrismaDocumentPurchaseRepository(prisma),
